...
set :user, 'ratchet.razzle.io'
set :domain, 'hoffberg'
set :deploy_to, '/var/www/ratchet.razzle.io'
set :repository, 'https://github.com/awesomelionel/ratchet.razzle.io.git'
set :branch, 'master'
set :port, '2233'
...
task :setup => :environment do
  ...
  queue! %[chmod g+rx,u+rwx "#{deploy_to}/log"]

  #queue! %[mkdir -p "#{deploy_to}/config"]
  #queue! %[chmod g+rx,u+rwx "#{deploy_to}/config"]
